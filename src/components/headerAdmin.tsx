...
import Logo from './kankunlogo';
    ...
    const currentDate = new Date().toLocaleDateString("es-ES", {
      weekday: "short", // Día de la semana (ej: "martes")
      year: "numeric", // Año (ej: "2023")
      month: "short",   // Mes (ej: "octubre")
      day: "numeric",  // Día del mes (ej: "10")
    });
...
const HeaderAdmin = () => {
    return (
    <header className=
    "w-full h-14 py-0 lg:px-[200px] sm:px-[20%] flex items-center  sticky top-10 left-0 z-[1000] before:content-[''] before:absolute before:w-10 before:h-10 before:-bottom-10 ">
            
            <div className="flex items-center w-full" >
                <span className="lg:text-3xl md:text-[18px] sm:text-md font-semibold w-[400px] flex-1 mb-2 bg-gradient-to-r text-red-300 text-transparent bg-clip-text">
                ¡Bienvenid@ Alondra Martinez!</span>
