  ...
  return (
    <main className="p-10 bg-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        <section>
          <h2 className="text-lg font-semibold text-red-500">Todas las reservas</h2>
          <div>
        ...
        <section>
          <h2 className="text-lg font-semibold text-red-500">Reservas Aceptadas</h2>
          {reservas
        ...
        <section>
          <h2 className="text-lg font-semibold text-red-500">Reservas Rechazadas</h2>
          {reservas
