  ...
  return (
    ...
    <div className="col-span-2 row-span-2">
      <Card className="bg-transparent border-none shadow-none h-full">
        <CardHeader>
          <CardTitle className="font-bold text-3xl text-gray-700">Resumen de ventas</CardTitle>
          <CardDescription>Estas mediciones son anuales en esta super pagina</CardDescription>
        </CardHeader>
        <CardContent>
